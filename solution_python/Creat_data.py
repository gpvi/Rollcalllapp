 ...
 # 随机生成5-8名长缺勤人数
    ...
    for i in vis:
        ...
        if i:
            ...
            veco.append(c)
    a_veoc = veco
    tep_int = randint(5,10)/10

    com_number  = round(tep_int* randint(5,8))
    for i in veci[:com_number+in_num]:
